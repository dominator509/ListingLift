...
export default function AdminJobQualityPage({ params }: { params: { jobId: string } }) {
  return (
    <main className="mx-auto max-w-7xl space-y-8 px-6 py-10">
      <PageHeader eyebrow={`Job ${params.jobId}`} title="Job quality control" description="Per-job output review for blockers, warnings, manual replacement needs, and delivery-blocking QC status." />
      <QualityControlBoard jobId={params.jobId} outputs={demoQualityOutputs} />
    </main>
  );
}
