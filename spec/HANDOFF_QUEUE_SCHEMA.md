...
- id: GAP-2026-06-09-003
  ...
  blocker: "node not present"
  exact_codex_commands: ["nvm install 20"]
...
- id: GAP-2026-06-09-004
  scope: src/app/
  blocker: "production build not executed"
  exact_codex_commands: ["pnpm build"]
  verify_command: "test -d dist/ || test -d .next/"
  owner: agent:codex-handoff
...
- id: GAP-2026-06-09-005
  ...
  exact_codex_commands: ["pnpm test -- --reporter=verbose"]
  verify_command: "pnpm test -- --reporter=basic --passWithNoTests"
  owner: agent:codex-handoff
  logged_by: agent:codex-phase2
  category: 5
  status: OPEN
...
- id: GAP-2026-06-09-006
  scope: __tests__/integration/
  blocker: "live API integration test requires C1 closed"
  exact_codex_commands: ["pnpm test -- -t 'integration'"]
  verify_command: "pnpm test -- -t 'integration' --reporter=basic"
  owner: agent:codex-handoff
  logged_by: agent:codex-phase2
  category: 6
  status: OPEN
