...
|----|--------|-----|---------|--------|----------|
| B1 | node | 20+ | `nvm install 20` | `node --version` | YES |
| B2 | pnpm | 8+ | `npm i -g pnpm` | `pnpm --version` | YES |
| B3 | jq | 1.6+ | `brew install jq` | `jq --version` | YES |

## 4. Accounts
| ID | Service | Type | Setup | Verify | Required |
|----|---------|------|-------|--------|----------|
| A1 | npm | publish | `npm login` | `npm whoami` | NO |
